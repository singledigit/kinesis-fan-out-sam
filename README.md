...
This is a sample template for kin - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name kin --tail
```
...
```bash
aws cloudformation delete-stack --stack-name kin
```
